...
# Описание активности
ABOUT_TEXT = """Тсс… Санта уже в пути! 🎅

Но на этот раз — это ты.

Зарегистрируйся, напиши, о чём мечтаешь — и жди, когда бот шепнёт тебе, чьим Тайным Сантой ты станешь.

Подарок — от 1500 ₽. Главное — дарить с душой!"""
